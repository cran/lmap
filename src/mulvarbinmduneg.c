...
void Cmulvarbinmduneg( int* rn, int* rr, double* ry, int* rm, double* ru, double* rv, int* rmains, double* rmu, int* rmaxiter, double* rdcrit, int* rmaxinner, double* rfcrit, double* rdeviance )
// Function Cmulvarbinmduneg() performs multivariate binary multidimensional unfolding.
...
// If not, see <https://www.gnu.org/licenses/>.
{
  ...
  for ( iter = 1; iter <= MAXITER; iter++ ) {
    ...
    mduneg( n, r, delta, m, u, v, d, MAXINNER, FCRIT, &inner, &fdif );
