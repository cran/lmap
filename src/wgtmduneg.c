...
long double wgtmduneg( const size_t n, const size_t m, double** delta, double** w, const size_t p, double** x, double** y, double** d, const size_t MAXITER, const long double FCRIT, size_t* lastiter, long double* lastdif )
{
...
void Cwgtmduneg( int* rn, int* rm, double* rdelta, double* rw, int* rp, double* rx, double* ry, double* rd, int* rmaxiter, double* rfdif, double* rfvalue )
// Function Cwgtmduneg() performs wighted multidimensional unfolding allowing negative dissimilarities.
...
// If not, see <https://www.gnu.org/licenses/>.
{
  ...
  long double fvalue = wgtmduneg( n, m, delta, w, p, x, y, d, MAXITER, FCRIT, &lastiter, &lastdif );
